...
export interface StreamGuardOptions {
  ...
  /** Captured by the openai/anthropic wrappers from the LLM request's
   *  messages, forwarded on every guarded tool call so the gateway's
   *  prompt-scoped rules (R013/R014/R015/R031/R032/R038) fire on
   *  tool-call traffic. */
