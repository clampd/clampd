...
AGENT_ID = _required_env("CLAMPD_AGENT_ID")
AGENT_SECRET = _required_env("CLAMPD_AGENT_SECRET")

# Attacker agent (sacrificial — will get killed by anomaly detector)
ATTACKER_ID = _required_env("CLAMPD_ATTACKER_ID")
ATTACKER_SECRET = _required_env("CLAMPD_ATTACKER_SECRET")

# Multi-agent IDs
ORCH_ID = _required_env("CLAMPD_ORCH_ID")
ORCH_SECRET = _required_env("CLAMPD_ORCH_SECRET")
RESEARCH_ID = _required_env("CLAMPD_RESEARCH_ID")
RESEARCH_SECRET = _required_env("CLAMPD_RESEARCH_SECRET")
ANALYSIS_ID = _required_env("CLAMPD_ANALYSIS_ID")
ANALYSIS_SECRET = _required_env("CLAMPD_ANALYSIS_SECRET")
WRITER_ID = _required_env("CLAMPD_WRITER_ID")
WRITER_SECRET = _required_env("CLAMPD_WRITER_SECRET")
...
def main():
    ...
    try:
        scan = client.scan_output(
            ...
            "STRIPE_SECRET_KEY=STRIPE_REDACTED_TEST_PLACEHOLDER\n"
